...
public class ServletAutobus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        a.setNum_autobus(Integer.parseInt(request.getParameter("num_autobus")));
        a.setSiglas(request.getParameter("siglas"));
        a.setModelo(Integer.parseInt(request.getParameter("modelo")));
        a.setCapacidad(Integer.parseInt(request.getParameter("capacidad")));
        a.setBase(request.getParameter("base"));
        
        AutobusDB aDB = new AutobusDB();
        try {
            int resultado = aDB.registrarAutobus(a);
            if (resultado >= 0){
